...
@Component({
  selector: 'OrderReport-home',
  templateUrl: './OrderReport-home.component.html',
  styleUrls: ['./OrderReport-home.component.scss']
})
export class OrderReportHomeComponent implements AfterViewInit {
