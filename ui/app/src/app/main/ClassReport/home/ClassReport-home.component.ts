...
@Component({
  selector: 'ClassReport-home',
  templateUrl: './ClassReport-home.component.html',
  styleUrls: ['./ClassReport-home.component.scss']
})
export class ClassReportHomeComponent implements AfterViewInit {
